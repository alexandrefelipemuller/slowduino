...
// int32_t -> int16_t: o valor JÁ CLAMPADO cabe à vontade em int16_t
// (IDLE_INTEGRAL_LIMIT=25600, dentro de +-32767) - mas a soma
// idleKI*err10 antes do clamp pode passar de 200000 num único passo, então
// essa conta continua em int32_t (variável local em idleControl()) e só o
// resultado já clampado é gravado aqui. Ver idleControl().
...
void idleControl() {
  ...
  // Soma feita num int32_t local: idleKI*err10 sozinho pode passar de
