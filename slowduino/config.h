...
#define EGO_DELAY_DEFAULT      30   // seconds
#define EGO_TEMP_DEFAULT       60   // °C
#define EGO_RPM_DEFAULT        15   // RPM / 100
#define EGO_TPS_MAX_DEFAULT    40   // %
#define EGO_MIN_DEFAULT        40
#define EGO_MAX_DEFAULT       160
#define EGO_LIMIT_DEFAULT      10
#define EGO_STEP_DEFAULT        1
#define EGO_IGN_EVENTS_DEFAULT  4
#define EGO_TARGET_DEFAULT    100
#define EGO_HYST_DEFAULT        5
